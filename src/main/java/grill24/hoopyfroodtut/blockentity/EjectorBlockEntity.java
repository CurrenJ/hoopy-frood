...
public class EjectorBlockEntity extends DispenserBlockEntity {
    ...
    private static final Component DEFAULT_NAME = Component.translatable("container.ejector");

    public EjectorBlockEntity(BlockPos pos, BlockState state) {
        super(HoopyFroodBlockEntityTypes.EJECTOR.get(), pos, state);
    }
    ...
    public static void tick(Level level, BlockPos pos, BlockState state, EjectorBlockEntity blockEntity) {
        Ejector.ejectTick(level, pos, state, blockEntity);
    }
}
